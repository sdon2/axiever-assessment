<div>
    <div class="row">
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="customer_name" name="customer_name" wire:model.lazy="customer_name"
                required>
            @error('customer_name')
        ...
        <div class="col-md-4">
            ...
            <input type="date" class="form-control" id="order_date" name="order_date" wire:model.lazy="order_date"
                required>
            @error('order_date')
                <div class="is-invalid text-danger">{{ $message }}</div>
            @enderror
        ...
        @if ($status == 'pending')
            <div class="col-md-4">
                ...
                <select class="form-select" id="status" name="status" wire:model.lazy="status"
    ...
    <div class="row mt-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="quantity" name="quantity"
                        wire:model.lazy="orderProducts.{{ $index }}.quantity" required
                        {{ $viewMode ? 'readonly' : '' }}>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" id="price" name="price" step="0.01"
                        wire:model.lazy="orderProducts.{{ $index }}.price" required
                        {{ $viewMode ? 'readonly' : '' }}>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                ...
                @endif
                <a href="{{ route('salesOrders.index') }}" class="btn btn-secondary">Back</a>
            </div>
        </div>
    </div>
</div>
